-- AssetFlow AI - Seed Data (Phase 4)

-- Note: In a real environment, profiles are usually created by Supabase Auth triggers.
-- Here we insert mock UUIDs for demonstration purposes.

-- Mock UUIDs (In practice, these would match auth.users IDs)
-- Admin: 00000000-0000-0000-0000-000000000001
-- Manager: 00000000-0000-0000-0000-000000000002
-- Dept Head: 00000000-0000-0000-0000-000000000003
